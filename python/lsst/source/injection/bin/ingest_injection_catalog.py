...
Parquet filenames will be read through daf_butler functions, whereas other file
types will attempt to use astropy.table.Table.read. See DM-44159 for details.
